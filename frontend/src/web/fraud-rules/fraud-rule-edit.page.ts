...
export class FraudRuleEditPage {
  ...
  protected readonly form = this.fb.group({
    ...
    reason_code: this.fb.control<string>(REASON_CODES[0], { nonNullable: true, validators: [Validators.required] }),
    field_name: this.fb.control<string>(FIELD_NAMES[0], { nonNullable: true, validators: [Validators.required] }),
    operator: this.fb.control<string>(OPERATORS[0], { nonNullable: true, validators: [Validators.required] }),
