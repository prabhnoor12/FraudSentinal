...
class FraudRule(Base):
    ...
    group_cap = Column(Float, nullable=True)
    exclude_rule_codes = Column(JSON, default=list, nullable=False)
    exclude_group_keys = Column(JSON, default=list, nullable=False)
    rule_version = Column(Integer, default=1, nullable=False, index=True)
